...
import sty from "./PlasmicCard.module.css"; // plasmic-import: at931Xm9Xbfa/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <div
              className={classNames(projectcss.all, sty.freeBox__i8Yq, {
                [sty.freeBoxnoTitle__i8Yq8K9Og]: hasVariant(
                  $state,
                  "noTitle",
                  "noTitle"
                )
            ...
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__siqW)}
                displayHeight={"auto"}
              ...
              <div
                className={classNames(projectcss.all, sty.freeBox__bWjyk, {
                  [sty.freeBoxnoTitle__bWjyk8K9Og]: hasVariant(
                    $state,
                    "noTitle",
                    "noTitle"
                  )
