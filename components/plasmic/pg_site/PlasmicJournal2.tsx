...
import sty from "./PlasmicJournal2.module.css"; // plasmic-import: 4o-o7RtBziJg/css

createPlasmicElementProxy;

export type PlasmicJournal2__VariantMembers = {};
export type PlasmicJournal2__VariantsArgs = {};
type VariantPropType = keyof PlasmicJournal2__VariantsArgs;
export const PlasmicJournal2__VariantProps = new Array<VariantPropType>();

export type PlasmicJournal2__ArgsType = {};
type ArgPropType = keyof PlasmicJournal2__ArgsType;
export const PlasmicJournal2__ArgProps = new Array<ArgPropType>();

export type PlasmicJournal2__OverridesType = {
  root?: p.Flex<"div">;
...
export interface DefaultJournal2Props {}
...
function PlasmicJournal2__RenderFunc(props: {
  variants: PlasmicJournal2__VariantsArgs;
  args: PlasmicJournal2__ArgsType;
  overrides: PlasmicJournal2__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicJournal2.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicJournal2.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__s8Kov)}
            displayHeight={"auto"}
          ...
          >
            ...
            {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
              (() => {
                try {
                  return $queries.articles.data.sort(
                ...
                >
                  <JournalPost2
                    ...
                    slot4={
                      <p.PlasmicImg
                        alt={""}
                        className={classNames(sty.img__egyq)}
                        displayHeight={"349px"}
...
const PlasmicDescendants = {
  root: ["root", "navBar", "section", "h1", "link", "journalPost2", "footer2"],
  navBar: ["navBar"],
  section: ["section", "h1", "link", "journalPost2"],
  h1: ["h1"],
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicJournal2__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicJournal2__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicJournal2__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicJournal2__ArgProps,
          internalVariantPropNames: PlasmicJournal2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicJournal2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicJournal2";
  } else {
    func.displayName = `PlasmicJournal2.${nodeName}`;
  }
  return func;
}

export const PlasmicJournal2 = Object.assign(
  // Top-level PlasmicJournal2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicJournal2
    internalVariantProps: PlasmicJournal2__VariantProps,
    internalArgProps: PlasmicJournal2__ArgProps,
...
export default PlasmicJournal2;
/* prettier-ignore-end */
